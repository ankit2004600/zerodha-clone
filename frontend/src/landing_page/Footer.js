...
Zerodha Broking Limited: Customers availing fixed deposit facilitation services offered by Blostem Fintech Private Limited will not have access to any exchange investor grievance redressal forum, SEBI SCORES/ODR, conciliation, or arbitration mechanism in respect of such fixed deposit products.</p>
   </div>
   </div>
     );
}
